...
{
    public class FC01RequestBuilder : RequestBuilder
    {
        public FC01RequestBuilder(ModbusServer modbusServer):base(modbusServer)
        {
            RequestBuilderName = "FC01 - Read coils";
