...
{
    public class FC03RequestBuilder : RequestBuilder
    {
        public FC03RequestBuilder(ModbusServer modbusServer) : base(modbusServer)
        {
            RequestBuilderName = "FC03 - Read holding registers";
